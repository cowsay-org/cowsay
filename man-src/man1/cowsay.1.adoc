...
*-C*::
    Enables true-color (24-bit) cows.  Currently only has an effect when used in conjunction with *-r*. If not given, then *-r* only selects from among non-true-color cows.
